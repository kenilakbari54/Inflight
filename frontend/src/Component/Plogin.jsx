  ...
  const submitHandler = async (event) => {
    ...
    try {
      const res = await fetch(
        `https://inflightcatering-system.onrender.com/api/vendors/login`,
        {
          method: 'POST',
          headers: {
              ...
              <div className="col-lg-7">
                ...
                <div className="sb-main-title-frame">
                  <div className="sb-main-title">
                    ...
                    <h1 className="sb-mb-30">Become A Partner with AeroEats</h1>
                    ...
                    <ul className="sb-breadcrumbs">
                      ...
                      <li>
                        <a href="menu-1.html">Partner's Login</a>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="sb-contact-form-frame">
                  <div className="sb-form-content">
                    <div className="sb-main-content">
                      <h3 className="sb-mb-30">Partner's Login</h3>
                    ...
                    <Link to="/Pregister" style={{ color: 'blue' }}>
